...
object What2EatIcons {
     ...
     * Q 版要点：椭圆米白团子（整蛋形无棱角）、深苔绿海苔围裙、头顶爱心呆毛、
    ...
    val Mascot: ImageVector by lazy {
        ImageVector.Builder(
            ...
            path(
                ...
                moveTo(37.2f, 23.2f)
                arcTo(13.2f, 13.8f, 0f, false, true, 10.8f, 23.2f)
                arcTo(13.2f, 13.8f, 0f, false, true, 37.2f, 23.2f)
                close()
            }
            // 头顶爱心呆毛（招牌元素）
